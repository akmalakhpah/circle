@extends('layouts.default')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form action="{{ url('employee/add') }}" class="ui form custom" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            {{ csrf_field() }}
                        ...
                        <div class="box-body">
                            <div class="two fields">
                                <div class="field">
                                    ...
                                    <input type="text" class="uppercase" name="firstname" value="" required="">
                                </div>
                                <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input type="text" class="uppercase" name="lastname" value="" required="">
                            </div>
                            <div class="field">
                                <label>Gender</label>
                            ...
                            <div class="field">
                                ...
                                <input type="email" name="emailaddress" value="" required="" class="lowercase">
                            </div>
                            <div class="field">
