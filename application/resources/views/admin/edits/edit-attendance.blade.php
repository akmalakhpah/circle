        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-content">
                    ...
                    <form action="{{ url('attendance/update') }}" class="ui form" method="post" accept-charset="utf-8">
                    {{ csrf_field() }}
                    ...
                    @else
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label for="">Time In <strong>Date</strong></label>
                                <input class="readonly" type="text" placeholder="Date" name="date" value="@isset($a->date){{ $a->date }}@endisset" readonly="" />
                            </div>
                        </div>
                    @endif
                    ...
                    @else
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label for="">Time Out <strong>Date</strong></label>
