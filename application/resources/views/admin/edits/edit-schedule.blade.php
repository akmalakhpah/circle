                ...
                {{ csrf_field() }}
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input type="text" placeholder="00:00 AM" name="intime" class="jtimepicker" value="@isset($s->intime){{ $s->intime }}@endisset"/>
                        </div>
                        <div class="field">
                            <label for="">Off Time</label>
                            <input type="text" placeholder="00:00 PM" name="outime" class="jtimepicker" value="@isset($s->outime){{ $s->outime }}@endisset"/>
                        </div>
                    </div>
                    ...
                    <div class="eight wide field">
                        ...
                        <input type="text" placeholder="00" name="hours" value="@isset($s->hours){{ $s->hours }}@endisset"/>
                    </div>


                    <div class="grouped custom fields">
