@extends('layouts.default')
        ...
        <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ url('users') }}" class="ui black grey small button"><i class="ui times icon"></i> Cancel</a>
                    </div>
    ...
    $(document).ready(function () {
        $('.opt-radio .checkbox').first().checkbox({ ischecked: function() {$('.role, .role .ui.dropdown').addClass('disabled');$('select[name="role_id"]').addClass('disabled').val(''); }});
    });
