@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ url('export/fields/jobtitle' )}}" class="ui basic button mini offsettop5 btm-export float-right"><i class="ui icon download"></i> Export</a>
                </h2>
            </div>    
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-aqua">
                    ...
                    <form role="form" action="{{ url('fields/jobtitle/add') }}" class="ui form" method="post" accept-charset="utf-8">
                        {{ csrf_field() }}
                        <div class="field">
                            ...
                            <select name="department" class="ui search dropdown getdeptcode">
                                ...
                                @isset($d)
                                    @foreach ($d as $dept)
                                        <option value="{{ $dept->department }}" data-id="{{ $dept->id }}"> {{ $dept->department }}</option>
                                    @endforeach
                                @endisset
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input class="uppercase" name="jobtitle" value="" required="" type="text" value="">
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('.ui.dropdown.getdeptcode').dropdown({ onChange: function(value, text, $selectedItem) {
            $('select[name="department"] option').each(function() {
                if($(this).val()==value) {var id = $(this).attr('data-id');$('input[name="dept_code"]').val(id);};
            });
        }});
