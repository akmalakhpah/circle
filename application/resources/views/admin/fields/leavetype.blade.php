        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-aqua">
                    <div class="box-body">
                        <form role="form" action="{{ url('fields/leavetype/add') }}" class="ui form" method="post" accept-charset="utf-8">
                            {{ csrf_field() }}
                            
                            <div class="field">
                                <label>Leave Name <span class="help">e.g. "Vacation Leave, Sick Leave"</span></label>
                                <input class="uppercase" name="leavetype" value="" required="" type="text" value="">
                            </div>

                            <div class="field">
                                <label>Credits <span class="help">e.g. "15" (days)</span></label>
                                <input class="" name="limit" value="" required="" type="text" value="">
                            </div>
