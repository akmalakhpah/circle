@extends('layouts.personal')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                <form action="{{ url('personal/profile/update') }}" class="ui form custom" method="post" accept-charset="utf-8">
                {{ csrf_field() }}
                            ...
                            <div class="box-body">
                                <div class="two fields">
                                    <div class="field">
                                        ...
                                        <input type="text" class="uppercase" name="firstname" value="@isset($person_details->firstname){{ $person_details->firstname }}@endisset" required="">
                                    </div>
                                    <div class="field">
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" class="uppercase" name="lastname" value="@isset($person_details->lastname){{ $person_details->lastname }}@endisset" required="">
                                </div>
                                <div class="field">
                                    <label>Gender</label>
                                ...
                                <div class="field">
                                    ...
                                    <input type="email" name="emailaddress" value="@isset($person_details->emailaddress){{ $person_details->emailaddress }}@endisset" required="" class="lowercase">
                                </div>
                                <div class="field">
                    ...
                    <div class="col-md-12 float-left">
                        <div class="action align-right">
                            ...
                            <a href="{{ url('personal/dashboard') }}" class="ui grey button small"><i class="ui times icon"></i> Cancel</a>
                        </div>
                    </div>
                </form>
        </div>
