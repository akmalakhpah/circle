...
class AttendanceController extends Controller
{
    ...
    public function index() {
        if (permission::permitted('attendance')=='fail'){ return view('errors.permission-denied'); }
    ...
    {
        if (permission::permitted('attendance-edit')=='fail'){ return view('errors.permission-denied'); }
    ...
    {
        if (permission::permitted('attendance-delete')=='fail'){ return view('errors.permission-denied'); }
