...
class UsersController extends Controller
{
    ...
    {
        if (permission::permitted('users-add')=='fail'){ return view('errors.permission-denied'); }
    ...
    {
        if (permission::permitted('users-delete')=='fail'){ return view('errors.permission-denied'); }
