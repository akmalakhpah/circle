...
class RolesController extends Controller
{
    ...
    {
        if (permission::permitted('roles')=='fail'){ return view('errors.permission-denied'); }
    ...
    public function add(Request $request) {
        if (permission::permitted('roles-add')=='fail'){ return view('errors.permission-denied'); }
    ...
    public function delete($id) {
        if (permission::permitted('roles-delete')=='fail'){ return view('errors.permission-denied'); }
    ...
    public function edit($id, Request $request) {
        if (permission::permitted('roles-edit')=='fail'){ return view('errors.permission-denied'); }
    ...
    public function editperm($id) {
        if (permission::permitted('roles-permission')=='fail'){ return view('errors.permission-denied'); }
