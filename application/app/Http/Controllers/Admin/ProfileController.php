...
class ProfileController extends Controller
{
    ...
    {
		if (permission::permitted('employees-view')=='fail'){ return view('errors.permission-denied'); }
    ...
    {
		if (permission::permitted('employees-archive')=='fail'){ return view('errors.permission-denied'); }
    ...
    {
		if (permission::permitted('employees-edit')=='fail'){ return view('errors.permission-denied'); }
