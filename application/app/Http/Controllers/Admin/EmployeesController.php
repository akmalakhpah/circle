...
class EmployeesController extends Controller
{
	...
	public function index() {
        if (permission::permitted('employees')=='fail'){ return view('errors.permission-denied'); }
	...
	public function new() {
		if (permission::permitted('employees-add')=='fail'){ return view('errors.permission-denied'); }
